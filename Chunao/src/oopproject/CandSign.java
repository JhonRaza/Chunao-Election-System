 ...
 * @author Jhon Raza
 */
public class CandSign extends javax.swing.JFrame {

    /**
     * Creates new form CandSign
     */
    public CandSign() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CandSign.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
